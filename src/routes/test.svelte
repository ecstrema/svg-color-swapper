<script lang="ts">
    ...
    let styledGroup: SVGGElement;
    onMount(() => {
        console.log(Array.isArray(divElement.childNodes));
        console.log(styledGroup.style.fill);
    })
</script>

<h1 bind:this="{divElement}">Test</h1>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="-52 -53 100 100" stroke-width="2">
    ...
    <g bind:this={styledGroup} style="fill:#66899a; stroke: white;">
